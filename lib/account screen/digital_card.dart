...
class Digitalcard_Screen extends StatefulWidget {
  const Digitalcard_Screen({super.key});

  @override
  State<Digitalcard_Screen> createState() => _Digitalcard_ScreenState();
}

class _Digitalcard_ScreenState extends State<Digitalcard_Screen> {
  @override
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Image(image: AssetImage('assets/trueguide.png'),),
                              ),
                              Text(
                                "SRI LAKSHMI GRP",
