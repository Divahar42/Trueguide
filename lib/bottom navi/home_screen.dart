        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            Padding(
                  ...
                  child: Row(children: [
                    ...
                    SizedBox(height: 30,width: 140,
                      child: ElevatedButton(
                          ...
                          onPressed: (){}, child: Text("Register Now",style: GoogleFonts.lato(textStyle: TextStyle(fontSize: 12,color: Colors.white)))),
                    )
                  ],),
                ),
              ),
              ...
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage("assets/growth.png"),fit: BoxFit.fill),
                borderRadius: BorderRadius.circular(8)
              ),
                child: Padding(
